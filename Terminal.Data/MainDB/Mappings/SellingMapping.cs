...
public class SellingMapping : IEntityTypeConfiguration<Selling>
{
    public void Configure(EntityTypeBuilder<Selling> builder)
    {
        builder.HasKey(e => e.TransactionShopKey);

            builder.ToTable("selling");

            builder.HasIndex(e => e.Guid, "TrTer").IsUnique();
            ...
            builder.Property(e => e.ExternalCode).HasColumnType("VARCHAR(255)");
